<script setup>
      ...
      // secondGroup = [4,5,6]
      // arr is now []
      const secondGroup = ImageClone.splice(0, 4);
...
<template>
      ...
      >
            <div class="p-4 space-y-4" data-aos="my-slide-left">
                  <div
            ...
            <div class="p-4 space-y-4" data-aos="my-slide-right">
                  <div
